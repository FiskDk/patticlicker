...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		l('versionNumber').innerHTML='v. '+Game.version+ '"Reversed" by ' + '<a href="https://f1sk.xyz">f1sk</a>' + '<div id="httpsSwitch" style="cursor:pointer;display:inline-block;background:url(img/'+(Game.https?'lockOn':'lockOff')+'.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>'+(Game.beta?' <span style="color:#ff0;">beta</span>':'');
		/*
	...
	Game.Logic=function()
	{
		...
		{
			var title='Patti Clicker - by f1sk';
